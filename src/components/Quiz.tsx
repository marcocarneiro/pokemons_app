...
const Quiz: React.FC = () => {
    ...
    return (
        <Box sx={{ width: '100vw', height: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Typography variant="h2" sx={{ position: 'relative', width: '370px'}}>
                <img src="/logo-alltype.svg" alt="Pokémon Logo" style={{ width: '250px', marginBottom: '20px' }} /> 
                <Typography variant="h2" sx={{ position: 'absolute', top: '20px', right: '0'}}>Quiz</Typography>
            </Typography>
